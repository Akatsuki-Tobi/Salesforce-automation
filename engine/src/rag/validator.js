...
exports.KnowledgeValidator = exports.CONFIDENCE_THRESHOLD = void 0;
const agent_js_1 = require("../types/agent.js");
exports.CONFIDENCE_THRESHOLD = 0.70;
class KnowledgeValidator {
    validate(content, source, url) {
        ...
        const approved = score.confidence >= exports.CONFIDENCE_THRESHOLD;
        return {
            approved,
            score,
            knowledgeType,
            reason: approved ? undefined : `Confidence ${score.confidence} below threshold ${exports.CONFIDENCE_THRESHOLD}`,
        };
    }
