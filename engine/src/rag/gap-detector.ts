import type { WorldModel, PlannerOutput, KnowledgeGap, LearningState } from "../types/agent.js";
...
export class GapDetector {
  ...
  private buildQuery(plan: PlannerOutput, worldModel: WorldModel): string {
  ...
  private buildQueryFromFailure(plan: PlannerOutput, worldModel: WorldModel): string {
    const goal = worldModel.goal;
    const action = plan.action;
